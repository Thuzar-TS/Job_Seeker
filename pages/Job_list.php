...
<div class="wrap col-md-12 pad-free">
    <div class="row">
        <div class="col-md-1 mb-20">
            <a href="Customer_create.php" class="btn btn-all col-md-12">職作成</a>
        </div>
    </div>
            ...
            <div class="col-md-12">                
                <div class="panel panel-info"> 
                    <div class="panel-body">
                        ...
                        <div class="col-md-11">
                            <a href="JobCreate3.php">職種名: アカウントエグゼクティブ </a><br>
                            Job ID: SF190025485 <br>
                            顧客ID: 000025 <br>
                            顧客名: 田中 <br><br>
            ...
            <div class="col-md-12">                
                <div class="panel panel-info"> 
                    <div class="panel-body">
                        ...
                        <div class="col-md-11">
                            <a href="JobCreate3.php">職種名: プロダクトセールス（証券化商品） </a><br>
                            Job ID: SF190025485 <br>
                            顧客ID: 000025 <br>
                            顧客名: 小林 <br><br>
                            <a href="#" class="edit-btn"><span class="glyphicon glyphicon-edit"></span></a>&nbsp;
            ...
            <div class="col-md-12">                
                <div class="panel panel-info"> 
                    <div class="panel-body">
                        ...
                        <div class="col-md-11">
                            <a href="JobCreate3.php">職種名: ウェブ開発者 </a><br>
                            Job ID: SF190025485 <br>
                            顧客ID: 000025 <br>
                            顧客名: 石川 <br><br>
                            <a href="#" class="edit-btn"><span class="glyphicon glyphicon-edit"></span></a>&nbsp;
